            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 overflow-x-scroll flex flex-col gap-6">
                        <div v-for="product in $page.props.cart.items" :key="product.uuid" class="border-b pb-6">
                            <div class="flex gap-4">
                                <div class="flex-none w-14">
                                    <img class="w-full aspect-square rounded"
                                ...
                                <div class="flex items-center ml-auto">
                                    <button type="button" class="btn btn-secondary w-8 h-8 p-4"

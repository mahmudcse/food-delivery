            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 overflow-x-scroll flex flex-col gap-8">
                        <div v-for="category in restaurant.categories" :key="category.id" class="flex flex-col gap-4">
                                ...
                                <div v-for="product in category.products" :key="product.id"
                                    ...
                                    <div class="grow flex flex-col gap-2">
                                        ...
                                        <div class="grow flex items-end">
                                            <button v-if="can('cart.add') || !$page.props.auth.user"
                                                @click="addProduct(product)" class="btn btn-primary btn-sm" type="button">

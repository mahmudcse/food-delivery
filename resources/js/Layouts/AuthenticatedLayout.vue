...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 w-full fixed top-0">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="can('product.viewAny') && can('category.viewAny')"
                                    :href="route('vendor.menu')" :active="route().current('vendor.menu')">Restaurant menu
                                </NavLink>
                                ...
                                <NavLink v-if="can('user.create')" :href="route('vendor.staff-members.index')"
